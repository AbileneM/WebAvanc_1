...
import { addEquipment, deleteEquipment, detailsEquipment, equipmentList, updateEquipment, updateEquipmentImage, laboratoryEquipments, departmentEquipments } from "../controllers/equipmentController.js";
...
route.all("*", verifierToken)
    ...
    //Ajouter des routes pour les laboratoires et les departements d'un equipement
    .get('/laboratory/:id', laboratoryEquipments)
    .get('/department/:id', departmentEquipments)
