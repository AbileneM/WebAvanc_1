...
import { addDepartment, deleteDepartment, departmentList, departmentSubjects, departmentUsers, detailsDepartment, updateDepartment, updateDepartmentImage,departmentEquipments, departmentLaboratories } from "../controllers/departmentController.js";
...
route
    ...
    //Ajouter des routes pour les laboratoires et les equipements d'un departement
    .get('/:id/laboratories', departmentLaboratories)
    .get('/:id/equipments', departmentEquipments)
